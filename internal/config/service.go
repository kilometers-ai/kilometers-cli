...
func (s *ConfigService) Load(ctx context.Context) (*UnifiedConfig, error) {
...
func (s *ConfigService) LoadWithOptions(ctx context.Context, opts LoadOptions) (*UnifiedConfig, error) {
...
func (s *ConfigService) Save(ctx context.Context, config *UnifiedConfig) error {
