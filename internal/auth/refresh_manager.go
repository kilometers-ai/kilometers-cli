...
func (m *AutoRefreshAuthManager) GetValidToken(ctx context.Context, scope string) (*AuthToken, error) {
...
func (m *AutoRefreshAuthManager) ForceRefresh(ctx context.Context, scope string) (*AuthToken, error) {
...
func (m *AutoRefreshAuthManager) refreshToken(ctx context.Context, scope string, existingToken *AuthToken) (*AuthToken, error) {
...
func (m *AutoRefreshAuthManager) attemptRefreshWithRetry(ctx context.Context, refreshToken string) (*AuthToken, error) {
	var lastErr error
...
func (m *AutoRefreshAuthManager) attemptGetTokenWithRetry(ctx context.Context, request *TokenRequest) (*AuthToken, error) {
	var lastErr error
