...
func (c *SecureFileTokenCache) GetToken(scope string) (*AuthToken, error) {
	c.mu.RLock()
	defer c.mu.RUnlock()
...
func (c *SecureFileTokenCache) SetToken(scope string, token *AuthToken) error {
	c.mu.Lock()
	defer c.mu.Unlock()
...
// GetToken retrieves a cached token for the given scope
func (c *MemoryTokenCache) GetToken(scope string) (*AuthToken, error) {
	c.mu.RLock()
	defer c.mu.RUnlock()
...
// SetToken stores a token for the given scope
func (c *MemoryTokenCache) SetToken(scope string, token *AuthToken) error {
	c.mu.Lock()
	defer c.mu.Unlock()
