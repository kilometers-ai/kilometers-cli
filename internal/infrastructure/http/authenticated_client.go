...
func NewAuthenticatedHTTPClient(authManager ports.AuthManager, scope string) *AuthenticatedHTTPClient {
...
func NewAuthenticatedRoundTripper(authManager ports.AuthManager, scope string) *AuthenticatedRoundTripper {
...
func CreateAuthenticatedClient(authManager ports.AuthManager, scope string) *http.Client {
	return &http.Client{
