...
func (s *UnifiedStorage) Save(ctx context.Context, config *domain.UnifiedConfig) error {
	return s.SaveToPath(ctx, config, s.configPath)
}

// SaveToPath saves configuration to a specific path
func (s *UnifiedStorage) SaveToPath(ctx context.Context, config *domain.UnifiedConfig, path string) error {
...
func (s *UnifiedStorage) LoadFromStorage(ctx context.Context) (*domain.UnifiedConfig, error) {
	...
	if !exists {
		return domain.DefaultUnifiedConfig(), nil
	}
...
func (s *UnifiedStorage) fromSaveableConfig(sc *SaveableConfig) *domain.UnifiedConfig {
...
func CreateConfigServiceFromDefaults() (ConfigService, error) {
	...
	return NewConfigService(loader, storage), nil
}

// ConfigService is a local alias to avoid import cycles
type ConfigService interface {
	Load(ctx context.Context) (*domain.UnifiedConfig, error)
	Save(ctx context.Context, config *domain.UnifiedConfig) error
	UpdateAPIKey(ctx context.Context, apiKey string) error
	ClearAPIKey(ctx context.Context) error
}

// NewConfigService creates a new configuration service
func NewConfigService(loader *UnifiedLoader, storage *UnifiedStorage) ConfigService {
...
func (s *configServiceImpl) Load(ctx context.Context) (*domain.UnifiedConfig, error) {
	return s.loader.Load(ctx)
}

func (s *configServiceImpl) Save(ctx context.Context, config *domain.UnifiedConfig) error {
	return s.storage.Save(ctx, config)
}

func (s *configServiceImpl) UpdateAPIKey(ctx context.Context, apiKey string) error {
...
func (s *configServiceImpl) ClearAPIKey(ctx context.Context) error {
	config, err := s.Load(ctx)
	if err != nil {
